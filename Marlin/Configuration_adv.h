...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 150*60, 150*60, 20*60, 20*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE  FILAMENT_CHANGE_FAST_LOAD_FEEDRATE/2  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    15  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  FILAMENT_CHANGE_UNLOAD_FEEDRATE  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     FILAMENT_CHANGE_UNLOAD_ACCEL  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    FILAMENT_CHANGE_UNLOAD_LENGTH-ADVANCED_PAUSE_PURGE_LENGTH  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define I_HYBRID_THRESHOLD      10
  #define J_HYBRID_THRESHOLD      10
  #define K_HYBRID_THRESHOLD      10
...
//#define FILAMENT_WIDTH_SENSOR
  ...
  #define MEASUREMENT_DELAY_CM        69.5    // (cm) The distance from the filament sensor to the melting chamber
  #define FILWIDTH_PIN P0_23
  #define FILWIDTH_ERROR_MARGIN        1.0  // (mm) If a measurement differs too much from nominal width ignore it
  #define MAX_MEASUREMENT_DELAY       100    // (bytes) Buffer size for stored measurements (1 byte per cm). Must be larger than MEASUREMENT_DELAY_CM.
